...
const Set<String> _clientCustomRequestsColumns = <String>{
  ...
  'nail_length',
  'nail_preferences',
  'left_hand_dimensions',
  'right_hand_dimensions',
  'preview_image',
  'preview_image_asset',
  'completed_at',
  'admin_notes',
  ...
  'nfc_selected',
  'nfc_count',
  'photo_upload_completed_at',
  'photo_upload_failed_at',
  'payment_notified_artist',
  'payment_notified_artist_at',
  'expired_at',
  'expired_notified_client',
  'brand_status',
  'artist_quote',
  'artist_completed_at',
  'declined_by_artist_emails',
  'open_to_artist_pool',
  'direct_artist_status',
  'artist_pool_status',
  'direct_request_released_to_pool_at',
  'direct_request_released_by_artist_email',
  'client_budget_min',
  'client_budget_max',
  'open_to_client_pool',
  'declined_by_client_emails',
  'accepted_by_client_email',
  'client_review_prompt_sent_at',
  'client_rating',
  'client_review_text',
  'client_review_submitted_at',
  'client_tip_amount',
  'client_tip_percent',
  'client_tip_custom_amount',
  'client_tip_submitted_at',
  'client_response_status',
  'direct_client_status',
  'campaign_name',
  'contact_name',
  'request_accept_by',
  'request_accept_by_display',
  'completion_review_status',
  'completion_decline_reason',
  'completion_decline_description',
  'completion_declined_at',
  'shipping_label_qr_data',
  ...
  'accepted_at',
  'cancelled_by',
  'last_client_declined_at',
  'released_to_artist_pool_at',
  'released_to_client_pool_at',
  ...
  'tip',
  'nail_size',
  'artist_completion_draft_photos',
  'shipping_qr_code',
  'declined_artist_name',
  'declined_artist_email',
};
...
const Set<String> _companyCustomRequestsColumns = <String>{
  ...
  'open_to_artist_pool',
  'nfc_requested',
  'requires_nfc_eligible_client',
  'eligible_nfc_client_emails',
  'selected_artist',
  'selected_client',
  'order_type',
  'order_type_label',
  ...
  'photo_upload_completed_at',
  'photo_upload_failed_at',
  'brand_has_inspiration_photos',
  'brand_photo_count',
  'brand_inspiration_photos',
  'inspiration_photos',
  'preview_image',
  'preview_image_asset',
  'client_location',
  ...
  'shipping_address_different_from_profile',
  'shipping_street',
  'shipping_city',
  'shipping_state',
  'shipping_zip',
  ...
  'expired_at',
  'expired_notified_client',
  'expired_notified_brand_admin',
  'expired_notified_accepted_client',
  'group_clients',
  'left_hand_dimensions',
  'right_hand_dimensions',
  'artist_profile_image',
  ...
  'accepted_group_client_emails',
  'declined_group_client_emails',
  'declined_by_client_emails',
  'declined_by_artist_emails',
  'review_prompt',
  'delivery_prompt',
...
class _LocalMeasurementsBody extends StatelessWidget {
  ...
  Widget _summaryRow({required String nailShape, required String nailLength}) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Expanded(flex: 5, child: _plainSummaryItem('Shape', nailShape)),
        Padding(
        ...
        Expanded(flex: 7, child: _plainSummaryItem('Length', nailLength)),
      ],
    );
  }
