...
class CompanyClientRequestCard extends StatelessWidget {
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (jntRevealDateLabel.trim().isNotEmpty)
                        _field(
                          'JNT Reveal Date',
                          compactDateDisplay(jntRevealDateLabel),
                        ),
                      const SizedBox(height: 10),
                      _field(
                        'Submitted Date',
                        _compactSubmittedLabel(submittedLabel),
                        labelWeight: FontWeight.w500,
                        valueWeight: FontWeight.w500,
                        italic: true,
                      ),
                      if (acceptByLabel.trim().isNotEmpty)
                        _field(
                          'Accept By',
                          compactDateDisplayOrDash(acceptByLabel),
                          labelWeight: FontWeight.w500,
                          valueWeight: FontWeight.w500,
                          italic: true,
                        ),
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (showNfcChip) ...[const SizedBox(height: 5), _nfcChip()],
                    const SizedBox(height: 4),
                    ClipRRect(
                      borderRadius: BorderRadius.zero,
                      child: Container(
  ...
  String _compactSubmittedLabel(String value) {
    final text = value.trim();
    if (text.toLowerCase().startsWith('submitted ')) {
      return 'Submitted ${compactDateDisplayOrDash(text.substring(10))}';
    }
    return compactDateDisplay(text).isEmpty ? text : compactDateDisplay(text);
  }
