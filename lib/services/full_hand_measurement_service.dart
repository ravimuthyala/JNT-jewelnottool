...
class FullHandMeasurementService {
  ...
  // see env/example.json). Without one, _apiKey is empty and every request
  // goes out with no x-api-key header, so the API rejects it (401/403)
  // instead of silently authenticating with a leaked credential -- fails
  // loudly in the response/logs rather than quietly working on a key nobody
  // chose to ship.
